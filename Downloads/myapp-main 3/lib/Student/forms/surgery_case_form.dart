...
class SurgeryCaseForm extends StatefulWidget {
  ...
  @override
  State<SurgeryCaseForm> createState() => _SurgeryCaseFormState();
}

class _SurgeryCaseFormState extends State<SurgeryCaseForm> {
